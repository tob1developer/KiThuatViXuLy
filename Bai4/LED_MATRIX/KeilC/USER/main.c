...
unsigned int chuE[8]={0x8000,0x8000,0xFC00,0x8000,0x8000,0xFC00,0x8000,0x8000};
...
unsigned int chuN[8]={0x3800,0x3000,0x2400,0x2400,0x1200,0x3400,0x3C00,0x3C00};
...
unsigned int chuS[8]={0x8100,0x3C00,0x3F00,0x8100,0x0300,0x3C00,0x0100,0x8300};
