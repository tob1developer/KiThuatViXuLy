...
unsigned int chuC[8]={0x8100,0x0100,0x3C00,0x3F00,0x3F00,0x3C00,0x0100,0x8100};
unsigned int chuD[8]={0x0100,0x3800,0x3C00,0x3C00,0x3C00,0x3C00,0x3800,0x0100};
unsigned int chuE[8]={0x0000,0x0000,0x3F00,0x0300,0x3F00,0x3F00,0x0000,0x0000}; 
unsigned int chuF[8]={0x0000,0x0000,0xC000,0xFC00,0xFC00,0xC000,0xC000,0xC000}; 
...
unsigned int chuN[8]={0x3800,0x3000,0x2400,0x2400,0x0c00,0x1C00,0x3C00,0x3C00};
...
unsigned int chuS[8]={0x8100,0x3C00,0x3F00,0x8100,0xFC00,0x3C00,0x0100,0x8300};
